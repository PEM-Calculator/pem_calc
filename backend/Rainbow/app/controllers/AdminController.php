...
class AdminController extends \Phalcon\Mvc\Controller
{
    ...
    public function ajaxAction()
    {
        ...
        try {
            switch($_POST['action'])
            {
                ...
                default:
                    throw new \Exception('Неверно указан запрос');
            }
        }
        catch(Exception $ex)
        {
    ...
    private function _createPageGroup($R, $name, $parent_id)
    {
        if($parent_id == null)
            $parent_id = 0;
	...
	public function authAction()
    {
        ...
        $person = \Rainbow\Models\Persons::findFirst(array(
